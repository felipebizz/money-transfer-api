 ...
 * <p>
 * INSERT INTO Account (UserName,Balance,CurrencyCode) VALUES ('felipebizz',100.0000,'USD'); --ID =1
 * INSERT INTO Account (UserName,Balance,CurrencyCode) VALUES ('luhanna',200.0000,'USD'); --ID =2
 * INSERT INTO Account (UserName,Balance,CurrencyCode) VALUES ('felipebizz',500.0000,'EUR'); --ID =3
 * INSERT INTO Account (UserName,Balance,CurrencyCode) VALUES ('luhanna',500.0000,'EUR'); --ID =4
 */
...
public class TestAccountService extends TestService {
    ...
    public void testGetAccountByUserName() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/account/1").build();
        ...
        assertTrue(account.getUserName().equals("felipebizz"));
    }
    ...
    */
    ...
    public void testGetAllAccounts() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/account/all").build();
        HttpGet request = new HttpGet(uri);
        HttpResponse response = client.execute(request);
        int statusCode = response.getStatusLine().getStatusCode();
        assertTrue(statusCode == 200);
    ...
    */
    ...
    public void testGetAccountBalance() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/account/1/balance").build();
        HttpGet request = new HttpGet(uri);
        HttpResponse response = client.execute(request);
        int statusCode = response.getStatusLine().getStatusCode();
        assertTrue(statusCode == 200);
        //check the content, assert user felipebizz have balance 100
    ...
    */
    ...
    public void testCreateAccount() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/account/create").build();
        BigDecimal balance = new BigDecimal(10).setScale(4, RoundingMode.HALF_EVEN);
        Account acc = new Account("felipebizz", balance, "CNY");
        ...
        assertTrue(aAfterCreation.getUserName().equals("felipebizz"));
    ...
    */
    ...
    public void testCreateExistingAccount() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/account/create").build();
        Account acc = new Account("luhanna", new BigDecimal(0), "USD");
        String jsonInString = mapper.writeValueAsString(acc);
        StringEntity entity = new StringEntity(jsonInString);
        HttpPut request = new HttpPut(uri);
        request.setHeader("Content-type", "application/json");
    ...
    */
    ...
    public void testDeleteAccount() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/account/3").build();
    ...
    */
    ...
    public void testDeleteNonExistingAccount() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/account/300").build();
        HttpDelete request = new HttpDelete(uri);
        request.setHeader("Content-type", "application/json");
        HttpResponse response = client.execute(request);
        int statusCode = response.getStatusLine().getStatusCode();
