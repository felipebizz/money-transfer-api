 ...
 * INSERT INTO User (UserName, EmailAddress) VALUES ('felipebizz','felipebizz@gmail.com');  --ID=1
 * INSERT INTO User (UserName, EmailAddress) VALUES ('luhanna','luhanna@gmail.com');  --ID=2
 * INSERT INTO User (UserName, EmailAddress) VALUES ('lucas','lucas@gmail.com');  --ID=3
 */
public class TestUserService extends TestService {
    ...
    */
    ...
    public void testGetUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/user/felipebizz").build();
        ...
        assertTrue(user.getUserName().equals("felipebizz"));
        assertTrue(user.getEmailAddress().equals("felipebizz@gmail.com"));
    ...
    public void testGetAllUsers() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/user/all").build();
        HttpGet request = new HttpGet(uri);
        HttpResponse response = client.execute(request);
        int statusCode = response.getStatusLine().getStatusCode();
        assertTrue(statusCode == 200);
    ...
    public void testCreateUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/user/create").build();
    ...
    */
    ...
    public void testCreateExistingUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/user/create").build();
        User user = new User("luhanna", "luhanna@gmail.com");
        String jsonInString = mapper.writeValueAsString(user);
        StringEntity entity = new StringEntity(jsonInString);
        HttpPost request = new HttpPost(uri);
        request.setHeader("Content-type", "application/json");
    ...
    public void testUpdateUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/user/2").build();
        User user = new User(2L, "luhanna", "luhanna123@gmail.com");
        String jsonInString = mapper.writeValueAsString(user);
        StringEntity entity = new StringEntity(jsonInString);
    ...
    */
    ...
    public void testUpdateNonExistingUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/user/100").build();
        User user = new User(2L, "luhanna", "luhanna123@gmail.com");
        String jsonInString = mapper.writeValueAsString(user);
        StringEntity entity = new StringEntity(jsonInString);
        HttpPut request = new HttpPut(uri);
    ...
    */
    ...
    public void testDeleteUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/user/3").build();
   ...
   */
    ...
    public void testDeleteNonExistingUser() throws IOException, URISyntaxException {
        URI uri = builder.setPath("/revolut-app/user/300").build();
        HttpDelete request = new HttpDelete(uri);
        request.setHeader("Content-type", "application/json");
        HttpResponse response = client.execute(request);
        int statusCode = response.getStatusLine().getStatusCode();
